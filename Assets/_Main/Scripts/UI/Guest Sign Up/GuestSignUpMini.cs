...
public class GuestSignUpMini : IMiniMvcs
{
    ...
    //  Initialization  -------------------------------
    public GuestSignUpMini(UIPopup popup, IContext context)
    {
        _popup = popup;
        _context = context;
    }
    ...
    public void Initialize()
    {
        if (!IsInitialized)
        {
            ...
            RequireContext();
            Context.CommandManager.AddCommandListener<SignInValidateCompletionCommand>(InitSignUpMVC);
        }
    }
    ...
    public void InitSignUpMVC(SignInValidateCompletionCommand command)
    {
