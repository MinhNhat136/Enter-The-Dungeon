    ...
    public class GuestSignUpView : MonoBehaviour, IView
    {
        ...
        public void Initialize(IContext context)
        {
            if (!IsInitialized)
            {
                ...
                Context.CommandManager.AddCommandListener<OnSignUpCompleteCommand>(HidePopup);
            }
        }
        ...
        private void OnDestroy()
        {
            ...
            Context.CommandManager.RemoveCommandListener<OnSignUpCompleteCommand>(HidePopup);
        }
        ...
        private void HidePopup(OnSignUpCompleteCommand command)
        {
