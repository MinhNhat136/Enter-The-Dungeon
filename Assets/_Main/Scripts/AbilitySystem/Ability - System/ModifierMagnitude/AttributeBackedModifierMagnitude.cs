...
namespace Atomic.AbilitySystem
{
    ...
    public class AttributeBackedModifierMagnitude : ModifierMagnitudeScriptableObject
    {
        ...
        {
            spec.Source.AttributeSystemComponent.GetAttributeValue(CaptureAttributeWhich, out var sourceAttributeValue);
        ...
        private AttributeValue? GetCapturedAttribute(GameplayEffectSpec spec)
        {
            ...
            switch (CaptureAttributeFrom)
            {
                ...
                case ECaptureAttributeFrom.Target:
                    spec.Target.AttributeSystemComponent.GetAttributeValue(CaptureAttributeWhich, out var targetAttributeValue);
