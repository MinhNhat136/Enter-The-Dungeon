...
namespace CBS.UI
{
    public class AtomicStoreWindow : MonoBehaviour
    {
        [SerializeField] private StoreTitleScroller titleScroller;
        [SerializeField] private ToggleGroup titleGroup;
        [SerializeField] private StoreContentScroller contentScroller;
        [SerializeField] private StoreLoad loadType;
