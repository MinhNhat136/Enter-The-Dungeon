...
namespace CBS.UI
{
    public class AtomicCurrencyPanel : MonoBehaviour
    {
        [SerializeField]
        ...
        private readonly List<AtomicCurrencyItem> _currenciesUI = new List<AtomicCurrencyItem>();
        ...
        private void SpawnItems(Dictionary<string, CBSCurrency> currencies)
        {
            ...
            foreach (var currencyPair in currencies)
            {
                ...
                var itemUI = item.GetComponent<AtomicCurrencyItem>();
